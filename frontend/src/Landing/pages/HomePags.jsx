      ...
      <div className="w-full max-w-6xl mx-auto px-4 py-8">
        ...
        >
          <form onSubmit={handleSearch} className="flex flex-col md:flex-row items-center gap-4">
            <div className="flex-1 relative w-full transition-transform transition-shadow duration-200 hover:-translate-y-1 hover:shadow-lg">
            ...
            <button
              type="submit"
              className="bg-blue-600 text-white font-semibold px-8 py-3 rounded-lg transition-transform transition-shadow duration-200 hover:-translate-y-1 hover:shadow-lg"
            >
              Search
            </button>
          </form>
